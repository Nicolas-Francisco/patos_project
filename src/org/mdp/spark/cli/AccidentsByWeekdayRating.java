...
//		);
		...
		JavaPairRDD<Tuple2<Integer, Integer>,Integer> USAccidentsWeekdays = USAccidentsRating.mapToPair(
				tup -> new Tuple2<Tuple2<Integer, Integer>,Integer> (
					new Tuple2<Integer, Integer>(tup._4(), tup._5()),
					1
				)
		);
		 ...
		 * Base value: (0,0)
		 */
		JavaPairRDD<Tuple2<Integer, Integer>, Tuple1<Integer>> USAccidentsWeekdayToSumCount =
		...
		JavaPairRDD<Integer, Tuple2<Integer, Integer>> USAccidentsWeekdayToSumCount2 = USAccidentsWeekdayToSumCount.mapToPair(
				tup -> new Tuple2<Integer, Tuple2<Integer, Integer>> (
						tup._2._1,
						tup._1
						)
				);
				
		JavaPairRDD<Integer, Tuple2<Integer, Integer>> USAccidentsWeekdayToSumCountSorted = USAccidentsWeekdayToSumCount2.sortByKey();
	

		JavaRDD<Tuple3<Integer, Integer, Integer>> USAccidentsWeekdayRating = USAccidentsWeekdayToSumCountSorted.map(
				tup -> new Tuple3<Integer, Integer, Integer>(tup._2._1, tup._2._2, tup._1)
		);
